...
import harryPotterMod.tombenpotter.harrypottermod.common.items.ItemBlinkCast;
...
public class ItemRegistry
{
	public static void registerItems()
	{
		...
		testBlink = new ItemBlinkCast("testBlink");
	}
	public static ItemSpellBook spellBook;
	public static ItemTestCast test;
	public static ItemBlinkCast testBlink;
}
