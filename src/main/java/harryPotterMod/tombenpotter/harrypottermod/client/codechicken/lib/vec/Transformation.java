...
public abstract class Transformation
{
	...
	/**
	 * Creates a transformation list composed of this transformation followed by t If this is a TransformationList, the transformation will be appended and this returned
	 */
