package harryPotterMod.tombenpotter.harrypottermod.client.codechicken.lib.vec;
...
public class Quat
{
	...
	public static Quat aroundAxis(double ax, double ay, double az, float angle)
	{
	...
	{
		return aroundAxis(axis.x, axis.y, axis.z, (float) angle);
	}

	public Quat setAroundAxis(double ax, double ay, double az, float angle)
	{
		angle *= 0.5;
	...
	public Quat setAroundAxis(Vector3 axis, float angle)
	{
